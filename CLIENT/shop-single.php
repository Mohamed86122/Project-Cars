...
<link rel='stylesheet' href='css/moscino/style.css' type='text/css' media='all'/>
					...
					<div id="content" role="main">
						...
						<div itemscope itemtype="http://schema.org/Product" class="product">
							<div class="images">
								...
								<img src="images/car_img5.png" alt=""></img></a>
							</div>
							<div class="summary entry-summary">
								...
								<form class="cart" method="post" enctype='multipart/form-data'>
									...
									<button type="submit" class="single_add_to_cart_button button alt">Details</button>
								</form>
							...
							<div class="related products">
								...
								<ul class="products">
									...
									<img src="images/car_img5.png" alt=""></img>
									<h3>Beige Fedora</h3>
